...
== Overview
JelphaBot is a desktop Task Manager. The user interacts with it using a CLI, but it has a GUI created with JavaFX. It is written in Java, and has about 15 kLoC.
