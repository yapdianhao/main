...
**Function 2: Display a list of tasks due for a selected date**
...
** Time how long a task takes to be completed.
** Displays overall productivity for the day and week.
...
**Function 3: Displays overall productivity for day and week**
...
[none]
* 1a1. JelphaBot detects that the task the reminder is associated to does not exist.
[none]
+
** 1a2. User enters new task index to be reminded.
** Steps 1b1-1b2 are repeated until the command entered is correct.
+
Use case resumes from step 2
