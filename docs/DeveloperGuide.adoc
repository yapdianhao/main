...
|`* * *` |visual student |be able to see my tasks due for specific days in a week or month | plan my schedule easily.
...
|`* * *` |organised student | be able to have a visual overarching view of my events and deadlines in a calendar|view my deadlines for specific days of school week with ease.
