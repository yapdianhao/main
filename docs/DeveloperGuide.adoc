...
Refer <<activity-swapping-groupedtasklist, here>> for the diagram describing this command.
...
Empty `SubgroupTaskList` members have to be hidden manually which requires complex logic.
