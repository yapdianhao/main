...
Removing a task from the Running Timer(s) header is similar to adding it, as illustrated by the Sequence Diagram <<sequence-updatingProductivityPanel, above>>.
