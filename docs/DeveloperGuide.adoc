...
Upon the completion of the execution of the command, the summary tab will be displayed with the contents of the Morning Call under "Due Today", and Night Debrief under "Done Today".
