...
The following section describes the software architecture and software design decisions for the implementation of JelphaBot.
...
// TODO include yall class names in here
...
The task category mechanism is facilitated by the `GroupedTaskList` interface.
...
When users modify the displayed category with the corresponding `list` command, a different GroupedTaskList is displayed in the main panel. +
...
To delete a reminder associated to a certain task,
