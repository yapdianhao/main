...
altered by running CalendarPanel#fillGridPane() like the other two commands fulfilling **Function 1**.

//todo add screenshots of selected dates and the red and blue dots of tasks and say MainWindow#updateTasksInCalendarDayCards() method after every execution of command



==== Design Considerations
// TODO: amanda
//for the lil dots can say i use filtered instead of like hashmap or tasks etc
//fill the grid pane ting can say instead of return new calendarPanel i jus clear and refill gridpane)
