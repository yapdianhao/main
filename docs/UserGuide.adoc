...
JelphaBot automatically tracks your productivity within the day, and provides a bar which allows you to track the progress of your tasks in the current week.
