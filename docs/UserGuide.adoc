...
The following table contains the formatting and symbols used in this guide.
...
Go to the respective links to find out more  about <<#add, adding>> or <<#edit, editing>> Tasks with priority.
