...
Switches to the productivity panel and shows the user's productivity for the day and highlights task with the most and
least time spent. +
Format: `productivity`
