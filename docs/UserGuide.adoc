...
****
icon:exclamation-circle[role="icon-important", size="2x"] Exiting the application before stopping any running timer wil cause all recorded time since the timer was started to be lost.
****
...
You can groups tasks based on their due date. This is also the default interface for the task list tab. +
Format: `list date`
