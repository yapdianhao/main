...
As seen above, JelphaBot has four tabs, namely Summary, Task List, Calendar and Productivity.
...
These details include the command function, format and example usage. The features would be depicted
...
The task list panel will then display your all tasks sorted by date as default. +
