...
image::CalendarUi.png[width="600"]
...
[.text-center]
.Example of expected result after running `calendar Apr-2020`
...
[.text-center]
.Example of expected result after running `calendar Mar-1-2020`
...
The Summary tab can be viewed by entering the command `summary` or its shortcut `:s`

Format: `summary`
Shorcut: `:S`

[.text-center]
.Expected result after running `summary`
image::SummaryView.png[width="600"]
