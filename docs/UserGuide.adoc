...
To aid in your understanding throughout this User Guide, you may find below the different symbols and
...
These include the function of the command, its format, and example usages. The features will be depicted
...
JelphaBot allows you to track and manage your tasks comprehensively.
