...
public class AddCommandParserTest {
    ...
    public void parse_allFieldsPresent_success() {
        ...
        assertParseSuccess(parser, PREAMBLE_WHITESPACE + DESCRIPTION_DESC_ASSIGNMENT
                                       + MODULE_CODE_DESC_ASSIGNMENT + DATE_TIME_ASSIGNMENT + TAG_DESC_GRADED,
        ...
        assertParseSuccess(parser, DESCRIPTION_DESC_ASSIGNMENT + MODULE_CODE_DESC_TUTORIAL
                                       + MODULE_CODE_DESC_ASSIGNMENT + TAG_DESC_GRADED, new AddCommand(expectedTask));
        ...
        assertParseSuccess(parser, DESCRIPTION_DESC_ASSIGNMENT + MODULE_CODE_DESC_ASSIGNMENT
                                       + DATE_TIME_ASSIGNMENT + DATE_TIME_TUTORIAL + TAG_DESC_GRADED,
            new AddCommand(expectedTask));
    ...
    public void parse_optionalFieldsMissing_success() {
        ...
        assertParseSuccess(parser, DESCRIPTION_DESC_TUTORIAL + MODULE_CODE_DESC_TUTORIAL + DATE_TIME_TUTORIAL,
            new AddCommand(expectedTask)
        );
    }
