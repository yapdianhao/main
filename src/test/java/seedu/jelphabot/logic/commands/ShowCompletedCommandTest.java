...
import static seedu.jelphabot.logic.commands.ShowCompletedCommand.MESSAGE_SUCCESS;
...
public class ShowCompletedCommandTest {
    ...
    public void execute_listIsFilteredByPredicate_success() {
        ...
        assertCommandSuccess(new ShowCompletedCommand(), model, expectedCommandResult, expectedModel);
    }
